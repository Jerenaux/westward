...
- Fatigue generated by offensive actions (melee and range only) *and* receiving damage? Same mitigating ability?

Bugs:
- Wrong logging of region in dashboard, + new/returning players
...
- DIsable some skills based on fatigue
- Add Bear + remains
